...
class CareGiverMeetingView extends StatelessWidget {
          ...
          Expanded(
            child: Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.groups_outlined, size: 80, color: AppTheme.primaryColor.withOpacity(0.1)),
                  const SizedBox(height: 24),
                  const Text('Meeting management coming soon', 
